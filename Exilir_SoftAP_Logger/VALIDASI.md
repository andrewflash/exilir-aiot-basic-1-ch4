...
- Program: 1.100.861 byte (83% dari partisi aplikasi default). Global RAM statis: 92.712 byte (28%), termasuk buffer 42 KB. Pemakaian heap Wi-Fi/HTTP saat runtime belum diukur.
